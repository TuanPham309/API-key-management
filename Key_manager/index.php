                    ...
                    <div class="navbar-vertical-content perfect-scrollbar scrollbar">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item"><a class="nav-link" href="register.php">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-unlock-alt"></span></span><span class="nav-link-text"> Đăng ký tài khoản</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                ...
                <div id="dashboard-actions">
                    ...
                    <a href="buyapi.php"><button class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-shopping-cart" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ml-1">Mua key Giọng Đọc</span></button></a>
            ...
            <table class="table table-sm table-dashboard fs--1 data-table border-bottom" data-options='{"responsive":false,"pagingType":"simple","lengthChange":true,"searching":true,"pageLength":10,"columnDefs":[{"targets":[0,6],"orderable":false}],"language":{"info":"_START_ to _END_ Items of _TOTAL_ — <a href=\"index.php\" class=\"font-weight-semi-bold\">  <span class=\"fas fa-angle-right\" data-fa-transform=\"down-1\"></span> </a>"},"buttons":["copy","excel"]}'>
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort pr-1 align-middle">Ngày hết hạn</th>
                  ...
                  require_once "config.php";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<a class="dropdown-item" href="index.php">Xem chi tiết</a>';
