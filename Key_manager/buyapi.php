            ...
            <div class="content">
                <nav class="navbar navbar-light navbar-glass navbar-top sticky-kit navbar-expand">
                    ...
                    <ul class="navbar-nav navbar-nav-icons ml-auto flex-row align-items-center">
                        <li class="nav-item dropdown dropdown-on-hover"><a class="nav-link pr-0" id="navbarDropdownUser" href="index.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<div class="card mb-3">
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                ...
                <div id="dashboard-actions">
                    ...
                    <a href="buytools.php"><button class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-shopping-cart" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ml-1">Mua Tools AutoVoices</span></button></a>
                </div>
            </div>
        </div>
    </div>
    <div class="card-body px-0 pt-0">
        <div class="dashboard-data-table">
            <table class="table table-sm table-dashboard fs--1 data-table border-bottom" data-options='{"responsive":false,"pagingType":"simple","lengthChange":true,"searching":true,"pageLength":10,"columnDefs":[{"targets":[0,6],"orderable":false}],"language":{"info":"_START_ to _END_ Items of _TOTAL_ — <a href=\"#!\" class=\"font-weight-semi-bold\">  <span class=\"fas fa-angle-right\" data-fa-transform=\"down-1\"></span> </a>"},"buttons":["copy","excel"]}'>
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="sort pr-1 align-middle"> Ký Tự </th>
        ...
        <tr class="btn-reveal-trigger">
            ...
            <td class="align-middle">1.500.000</td>
            ...
            <td class="align-middle text-center fs-0">
                <span class="badge badge rounded-capsule badge-soft-danger">12 Lượt Mua<span class="ml-1 fas fa-check" data-fa-transform="shrink-2"></span></span>
            </td>
        </tr>
        <tr class="btn-reveal-trigger">
            <td class="align-middle">
            ...
            <td class="align-middle">4.700.000</td>
            <td class="align-middle">MB Bank</td>
            <td class="align-middle">0865814259</td>
            <td class="align-middle">Phạm Văn Tuấn </td>
            <td class="align-middle">850,000VNĐ</td>
            <td class="align-middle text-center fs-0">
                <span class="badge badge rounded-capsule badge-soft-warning">24 Lượt Mua<span class="ml-1 fas fa-check" data-fa-transform="shrink-2"></span></span>
            </td>
        </tr>
        <tr class="btn-reveal-trigger">
            <td class="align-middle">
            ...
            <td class="align-middle">9.800.000</td>
            <td class="align-middle">MB Bank</td>
            <td class="align-middle">0865814259</td>
            <td class="align-middle">Phạm Văn Tuấn </td>
            <td class="align-middle">1,150,000VNĐ</td>
            <td class="align-middle text-center fs-0">
                <span class="badge badge rounded-capsule badge-soft-success">20 Lượt Mua<span class="ml-1 fas fa-check" data-fa-transform="shrink-2"></span></span>
            </td>
        </tr>
        <tr class="btn-reveal-trigger">
            <td class="align-middle" class="badge badge rounded-capsule badge-soft-success" colspan="12">Nội Dung Thanh Toán: Tên Tài Khoản + Số điện thoại+ tháng + mua api giọng đọc .</td>
      
    </tbody>
            </table>
            <h2 class="badge badge-soft-info rounded-capsule ml-2" > Nội Dung Thanh Toán: Tên Tài Khoản Đăng ký  + Số điện thoại đăng ký zalo + tháng + mua api giọng đọc . | Bạn sẽ Được kích hoạt API trong Tools !! Cảm ơn</h2>
            <a class="fs-0 mb-0 text-nowrap py-2 py-xl-0" >Nếu chưa thấy Email hãy liên hệ admin qua:</a>
